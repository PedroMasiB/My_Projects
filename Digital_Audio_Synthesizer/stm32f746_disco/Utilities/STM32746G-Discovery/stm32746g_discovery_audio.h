...
#define AUDIO_OUT_IRQ_PREPRIO                    ((uint32_t)0x03)   /* Select the preemption priority level(0 is the highest) */
...
#define AUDIO_IN_IRQ_PREPRIO                     ((uint32_t)0x03)   /* Select the preemption priority level(0 is the highest) */
...
// default gain (affects o/p to HP) changed 2 May 2017 by DSR (was 64)
